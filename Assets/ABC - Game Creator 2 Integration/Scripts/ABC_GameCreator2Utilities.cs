...
#region Public Methods
    ...
    public ABC_GameCreator2Utilities(ABC_IEntity Entity) {
        ...
        this.gc2Character = Entity.transform.GetComponent<GameCreator.Runtime.Characters.Character>();

#if ABC_GC_2_Stats_Integration
        this.gc2Traits = Entity.transform.GetComponent<GameCreator.Runtime.Stats.Traits>();
#endif
    ...
    public void AllowGC2Rotation(bool Enabled) {
        ...
        //AllowRotationFlag no longer exists in GC2
        //if (this.gc2Character != null)
